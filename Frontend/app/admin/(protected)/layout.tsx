...
import {
    Users, Home, BookOpen, LogOut, ChevronDown, Shield, UserCircle
} from 'lucide-react';
                    ...
                    <div className="mt-2">
                        ...
                        {isStudentsOpen && (
                            <div className="py-2 pl-8 pr-4">
                                <Link href="/admin/students?view=all" className={`block px-4 py-2 mt-1 text-sm rounded-lg ${pathname === '/admin/students' ? 'text-primary font-semibold' : 'text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-400 dark:hover:text-white'}`}>All Students</Link>
                                <Link href="/admin/students?view=unassigned" className={`block px-4 py-2 mt-1 text-sm rounded-lg ${pathname === '/admin/students' ? 'text-primary font-semibold' : 'text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-400 dark:hover:text-white'}`}>Unassigned Students</Link>
                            </div>
                        )}
                    </div>
